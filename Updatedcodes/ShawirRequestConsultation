                                ...
                                showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return Directionality(
                                      ...
                                      content: const Text(
                                        ' هذا الخيار يعني ترسل طلبك '
                                            'و بإمكان أي محامٍ الاطلاع على التفاصيل وقبول الاستشارة إذا كان السعر مناسبًا له',
                                        textAlign: TextAlign.right,
                                      ),
                                      actions: [
                                        TextButton(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: isAgreed
                            ...
                            if (forSpecificLawyer && (selectedLawyer == null || selectedLawyer!.isEmpty)) {
                              ScaffoldMessenger.of(context).showSnackBar(

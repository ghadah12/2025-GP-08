              ...
              children: <Widget>[
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => LawyerSchedulePage()),
                        );
                      },
                      child: Container(
                ...
                ...List.generate(titles.length, (index) {
                  ...
                  final double topOffset = isLawyer
                      ? (index < 2 ? size.height * 0.43 : size.height * 0.6)
                      : (index < 2 ? size.height * 0.40 : size.height * 0.58);
                  final double horizontalOffset = size.width * 0.07;
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const LegalChatBot()),
                  );
                },
              child: Stack(
